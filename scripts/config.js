var __master_config = 	
{
	...
	'items': [
		...
		'type':'1',
		'items': [
		    { 'id' : 'bangalore', 'label': 'Bangalore','poster':'assets/images/bangalore.jpg'},
		    { 'id' : 'mysore', 'label': 'Mysore','poster':'./assets/images/mumbai.jpg'},
		    { 'id' : 'mumbai', 'label': 'Mumbai', 'poster':'./assets/images/pune.jpg'},
		    { 'id' : 'delhi', 'label': 'Delhi','poster':'./assets/images/delhi.jpg' },
		    { 'id' : 'jaipur', 'label': 'Jaipur','poster':'./assets/images/pune.jpg'},
		    { 'id' : 'ahmedabad', 'label': 'Ahmedabad','poster':'./assets/images/pune.jpg'},
		    { 'id' : 'chennai', 'label': 'Chennai','poster':'./assets/images/pune.jpg'},
		    { 'id' : 'hyd', 'label': 'Hyderabad','poster':'./assets/images/pune.jpg' },
		    { 'id' : 'pune', 'label': 'Pune' ,'poster':'./assets/images/pune.jpg'},
		    { 'id' : 'others', 'label': 'Others','poster':'./assets/images/pune.jpg' },
			{ 'id' : 'adda', 'label': 'Others','poster':'./assets/images/adda_1.jpg' },
		]
	    },
