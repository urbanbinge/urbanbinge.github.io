  ...
  ejs.MultiSearchRequest = function (conf) {
    ...
    return {
      ...
      doSearch: function (successcb, errorcb) {
        ...
        return ejs.client.get(getRestPath(), data, successcb, errorcb);
      }
  ...
  ejs.Request = function (conf) {
    ...
    return {
      ...
      doSearch: function (successcb, errorcb) {
        ...
        return ejs.client.get(getRestPath(''), queryData, successcb, errorcb);
      },
      ...
      doSearchShards: function (successcb, errorcb) {
        ...
        return ejs.client.get(getRestPath(''), '', successcb, errorcb);
      }
