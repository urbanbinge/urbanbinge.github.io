...
<body>
	<div class="container">
		<div class="starter-template">
			<h3>Something went wrong. The Payment was unsuccessful</h3>
			<hr />
			<p>
				The ticket has not been booked. Payment failure details are mailed
				to provided email-id<br> Thank you for using <a
					href="https://www.urbanbinge.com">urbanbinge.com</a>
			</p>
		</div>
	</div>
	<!-- /.container -->
